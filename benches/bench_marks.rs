...
fn criterion_bechmark(c: &mut Criterion) {
    let inputs = vec![Series::arange(0, 10000)];
    ...
    c.bench_function("series index", |b| {
        b.iter_with_setup(
    ...
    c.bench_function("series append", |b| {
        b.iter_with_setup(
            || Series::arange(0, 10000),
            |mut series| {
                series.append(1);
    ...
    */
    ...
    c.bench_function("series scalar ops - (Mul)", |b| {
        b.iter_with_setup(
            || Series::arange(0, 10000),
            |series| {
    ...
    c.bench_function("series scalar ops - (MulAssign)", |b| {
        b.iter_with_setup(
            || {
    ...
    c.bench_function("series agg ops (MODE)", |b| {
        b.iter_with_setup(
            || {
    ...
    c.bench_function("series agg ops (VAR)", |b| {
        b.iter_with_setup(
            || Series::arange(0, 10000),
            |series| {
    ...
    c.bench_function("series agg ops (STD)", |b| {
        b.iter_with_setup(
            || Series::arange(0, 10000),
            |series| {
    ...
    c.bench_function("series agg ops (MEDIAN)", |b| {
        b.iter_with_setup(
            || Series::arange(0, 10000),
            |series| {
    ...
    c.bench_function("series rolling (MEAN)", |b| {
        b.iter_with_setup(
            || {
                let series = Series::arange(0, 10000);
                series
